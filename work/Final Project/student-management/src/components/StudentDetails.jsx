...
const StudentDetails = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-white to-blue-50 dark:from-gray-900 dark:to-gray-800">
        <div className="text-xl flex items-center space-x-2 text-gray-800 dark:text-white">
          <svg
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white to-blue-50 dark:from-gray-900 dark:to-gray-800 p-6 flex flex-col items-center">
      <div className="max-w-3xl w-full bg-white dark:bg-gray-800 shadow-xl rounded-lg p-8 transition-all duration-300 hover:shadow-2xl">
        <h2 className="text-3xl font-bold text-gray-800 dark:text-white mb-6 relative after:absolute after:-bottom-2 after:left-0 after:w-20 after:h-1 after:bg-blue-500 after:rounded-full after:transition-all after:duration-300 hover:after:w-24">
          Student Details
        </h2>
